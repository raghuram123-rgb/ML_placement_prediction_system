...
df = pd.read_csv(
    r"C:\Users\Lenovo\PycharmProjects\ML_Project_New(placement_prediction)\Dataset\placement_predict_50K_Raw.csv"
)
...
final_output.to_csv(
path_or_buf=r"C:\Users\Lenovo\PycharmProjects\ML_Project_New(placement_prediction)\Dataset\clean_one_hot_encoding_M2.csv",
   index=False
)
