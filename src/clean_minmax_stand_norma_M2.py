...
file_path = r"C:\Users\Lenovo\PycharmProjects\ML_Project_New(placement_prediction)\Dataset\placement_predict_50K_Raw.csv"
...
# ---------------------------------------------------
df.to_csv(
    r"C:\Users\Lenovo\PycharmProjects\ML_Project_New(placement_prediction)\Dataset\clean_minmax_stand_norma_M2.csv",
    index=False
)
