...
FILE_NAME = r"C:\Users\Lenovo\PycharmProjects\ML_Project_New(placement_prediction)\Dataset\final_preprocessing_M2.csv"
OUTPUT_FOLDER = r"C:\Users\Lenovo\PycharmProjects\ML_Project_New(placement_prediction)\Outputs\Regularization_Ridge_Lasso_Elastic_M2"
...
comparison.to_csv(
    r"C:\Users\Lenovo\PycharmProjects\ML_Project_New(placement_prediction)\Dataset\regularisation_model_comparison_M2.csv",
    index=False
)
...
coefficient_table.to_csv(
    r"C:\Users\Lenovo\PycharmProjects\ML_Project_New(placement_prediction)\Dataset\regularisation_coefficients_M2.csv",
    index=False
)
...
lasso_features.to_csv(
    r"C:\Users\Lenovo\PycharmProjects\ML_Project_New(placement_prediction)\Dataset\lasso_feature_selection_M2.csv",
    index=False
)
