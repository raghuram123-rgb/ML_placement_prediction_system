...
df = pd.read_csv("C:/Users/Lenovo/PycharmProjects/ML_Project_New(placement_prediction)/Dataset/placement_predict_50K_Raw.csv")
...
data.to_csv(
   "C:/Users/Lenovo/PycharmProjects/ML_Project_New(placement_prediction)/Dataset/clean_label_encode_M2.csv",
   index=False
)
